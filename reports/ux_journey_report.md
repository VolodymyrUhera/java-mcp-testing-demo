...
|------|-------------------|--------|--------------|
| 1. Open Home Page | http://localhost:8080/ | Success | 93 |
| 2. Click About Us Link | http://localhost:8080/about | Success | 59 |
| 3. Return to Home Page | http://localhost:8080/ | Success | 81 |
| 4. Click Secret Portal (Contact) | http://localhost:8080/contact | Success | 115 |
| 5. Fill Contact Form Fields | http://localhost:8080/contact | Success | 66 |
| 6. Submit Form | http://localhost:8080/contact | Success | 133 |
